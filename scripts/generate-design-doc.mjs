...
const outPath = join(__dirname, "..", "docs", "evento-design-documentation.md");
const mntPath = "/mnt/user-data/outputs/evento-design-documentation.md";

const doc = `# Evento — Visual & Interaction Design Documentation
...
try {
  mkdirSync(dirname(mntPath), { recursive: true });
  writeFileSync(mntPath, doc, "utf8");
  console.log("Wrote", mntPath);
} catch (e) {
  console.log("Skipped mnt path:", e.message);
}
