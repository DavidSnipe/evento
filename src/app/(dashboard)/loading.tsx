    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 grid-cols-1 sm:grid-cols-3">
        {[1, 2, 3].map((card) => (
          <div
            key={card}
            className="rounded-2xl border border-border/30 bg-white/80 p-5 shadow-sm"
          >
      ...
      {/* Main panel skeleton */}
      <div className="rounded-2xl border border-border/30 bg-white/80 p-6 shadow-sm space-y-4">
